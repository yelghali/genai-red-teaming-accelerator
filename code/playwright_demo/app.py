...
AZURE_OPENAI_ENDPOINT = os.getenv("AZURE_OPENAI_GPT4O_ENDPOINT", "https://your-openai-resource.openai.azure.com/")
AZURE_OPENAI_KEY = os.getenv("AZURE_OPENAI_GPT4O_KEY", "your-azure-openai-key")
DEPLOYMENT_NAME = os.getenv("AZURE_OPENAI_DEPLOYMENT_NAME", "gpt-4o")  # Replace with your deployment name

# Initialize Azure OpenAI client
openai_client = AzureOpenAI(
    azure_endpoint="https://yayagot4o.openai.azure.com/",#TODO : change
    api_key="",
